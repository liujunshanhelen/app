    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent mainIntent = new Intent(Main_activity.this, login.class);
        ...
        btn_match.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                permission.verifyStoragePermissions();
                Log.i("widgetDemo", "匹配 被用户点击了。");
                Intent mainIntent = new Intent(Main_activity.this, toComputer.class);
                Bundle bundle=new Bundle();
                bundle.putString("name",name_owner);
                bundle.putString("power",power_owner);
                mainIntent.putExtras(bundle);
                //permission.verifyStoragePermissions(Main_activity.this);
                Main_activity.this.startActivity(mainIntent);
                Main_activity.this.finish();
                overridePendingTransition(R.anim.zoomin, R.anim.zoomout);
            }
        ...
        //设置按钮的监听
        ImageButton btn_add = (ImageButton) this.findViewById(R.id.add);
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.i("widgetDemo", "注册 被用户点击了。");
                Intent mainIntent = new Intent(Main_activity.this, sign_up1.class);
                Bundle bundle=new Bundle();
                bundle.putString("name",name_owner);
                bundle.putString("power",power_owner);
                mainIntent.putExtras(bundle);
        ...
        //设置按钮的监听
        ImageButton btn_search = (ImageButton) this.findViewById(R.id.search);
        btn_search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.i("widgetDemo", "搜索 被用户点击了。");
                Intent mainIntent = new Intent(Main_activity.this, search.class);
                Bundle bundle=new Bundle();
                bundle.putString("name",name_owner);
                bundle.putString("power",power_owner);
                mainIntent.putExtras(bundle);
    ...
    public void btdialog(View view) {
        commomDialog = new CommomDialog(Main_activity.this, R.style.dialog, "请输入地址", new CommomDialog.OnCloseListener() {
