...
public class TableView extends RelativeLayout {
    ...
    private int headbackground = R.color.none;
    private int head_text_color = Color.rgb(255, 255, 255);
    private String head_text;
    private int rownum;
    private int colnum;
    private int table_head_background = R.color.none;
    private int table_head_textcolor = Color.rgb(255, 255, 255);
    private int table_content_backgroumd = R.color.none;
    ...
    private void inittablecontent(String[] mlistContent) {
        ...
        for (int row = 0; row < rows; row++) {
            ...
            for (int col = 0; col < columns; col++) {
                ...
                if(col+columns*row<mlistContent.length)
                mColumn.setText(mlistContent[col+columns*row]);
                else
//                    mColumn.setText(mlistContent[col]);
                mColumn.setTextColor(Color.rgb(100,100,100));
    ...
    private void initHead(String[] mlistHead) {
        ...
        for (int col = 0; col < columns; col++) {
            ...
            mColumn.setBackgroundResource(R.drawable.shapee_gray);
            mColumn.setGravity(Gravity.CENTER);
            mColumn.setTextColor(Color.rgb(0, 0, 0));
